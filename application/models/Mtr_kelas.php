...
class Mtd_kelas extends CI_Model {
	...
	public function getTrKelasById($id)
	{
		$this->db->from($this->table);
	...
	public function addTrKelas($data)
	{
		$this->db->insert($this->table, $data);
		return $this->db->insert_id();
	}

	public function updateTrKelas($where, $data)
	{
...
/* End of file Mtd_kelas.php */
/* Location: ./application/models/Mtd_kelas.php */